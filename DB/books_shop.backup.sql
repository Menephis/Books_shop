...
--
-- Host: localhost
-- Generation Time: Dec 26, 2016 at 04:17 PM
...
INSERT INTO `books_properties` (`books_book_id`, `authors`, `date_of_release`, `language`, `printing`) VALUES
(2, 'Михаил Булгаков', 2016, 'русский', 12000),
(3, 'Фёдор Достоевский', 2014, 'русский', 15000),
(4, 'Борис Пастернак', 2013, 'русский', 10000);
...
--
ALTER TABLE `books`
  MODIFY `book_id` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `books_log`
--
ALTER TABLE `books_log`
  MODIFY `books_log_id` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
